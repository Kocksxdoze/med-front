...
function Cabinet() {
  ...
  const handleSave = () => {
    ...
    if (userRole === "laboratory") {
      ...
      endpoint = `http://localhost:4000/lab/update/${selectedLabId}`;
      ...
      if (saveTarget === "diagnosis") {
        ...
        endpoint = `http://localhost:4000/dia/update/${selectedDiagnosisId}`;
        ...
        endpoint = `http://localhost:4000/offer/update/${selectedOfferId}`;
